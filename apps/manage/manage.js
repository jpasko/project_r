/**
 * Management Node.js application for AdCrafted.
 *
...
app.configure("local", function() {
    console.log("Using local settings for Management Application.");
...
/**
 * The internal API, to be secured by a session-based authentication service.
 */
